            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-6'>
              <div className='bg-gray-50 p-6 rounded-lg flex flex-col gap-4'>
                ...
                <div>
                  ...
                  <Link href={`http://${user?.website}`} className='font-medium text-lg text-blue-500 hover:underline' target='_blank'>{user?.website}</Link>
                </div>
              </div>
              <div className='bg-gray-50 p-6 rounded-lg flex flex-col gap-4'>
                ...
                <div>
                  ...
                  <p className='font-medium text-lg text-gray-700'>{user?.address.geo.lat}, {user?.address.geo.lng}</p>
                </div>
              </div>
            </div>
